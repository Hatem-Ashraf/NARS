...
const staffRoles = ({ cookies }) => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const r = await fetch(
        `http://localhost:8081/staff/role/${staff.current.value}`,
        {
          method: "Delete",
  ...
  let fail = (
    ...
    >
      ...
      <div class="ml-3 text-sm font-medium">
        Failed to remove roles for the choosen user
  ...
  let success = (
    ...
    >
      ...
      <div class="ml-3 text-sm font-medium">
        Roles has been removed successfully
        <a href="#" class="font-semibold underline hover:no-underline"></a>
      </div>
      <button
        onClick={closeMsg}
        ...
        >
          <div className="contentAddUser2 flex flex-col gap-10">
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                class="w-[11rem]  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm md:text-lg px-5 py-2.5 mx-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Remove roles
              </button>
            </div>
