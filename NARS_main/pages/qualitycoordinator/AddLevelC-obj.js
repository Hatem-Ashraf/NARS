...
const addfaculty = ({ cookies }) => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const r = await fetch(`http://localhost:8085/programObj/faculty/${userState.faculty}`, {
        method: "POST",
      ...
      if (resp.error) {
        ...
        setTimeout(() => {
          window.location.href = "/qualitycoordinator/view-all-level-C";
        }, 1500);
      }
    } catch (e) {
      console.log(e);
  ...
  let fail = (
    ...
    >
      ...
      <div class="ml-3 text-lg font-medium">
        Failed to create Program Objective
  ...
  let success = (
    ...
    >
      ...
      <div class="ml-3 text-lg font-medium">
        Program Objective has been Created successfully
        <a href="#" class="font-semibold underline hover:no-underline"></a>
      </div>
      <button
        onClick={closeMsg}
      ...
      <div className="flex flex-row h-screen mt-5 mb-5">
        ...
        >
          <div className="contentAddUser2 flex flex-col gap-10 overflow-auto">
            <p className="font-normal text-3xl text-indigo-800">Add Program Objectives</p>
