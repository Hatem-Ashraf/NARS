...
const Students = ({ cookies }) => {
  ...
  const submitHandler = async () => {
    try {
      ...
      setStudents(data.competences);
      setFilteredStudents(data.competences);
    } catch (e) {
      console.log(e);
    }
  };
            ...
            <div className="w-full p-8 rounded-lg" >
              ...
              {filteredStudents.length > 0 ? (
                <>
                  ...
                  <CompetencesList competences={filteredStudents} setCompetences={setFilteredStudents}  level="level-A"/>
                </>
              ) : (
