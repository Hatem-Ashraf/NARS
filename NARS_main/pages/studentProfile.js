...
const studentProfile = ({ cookies }) => {
    ...
    const passowrdHandler = async (e) => {
        ...
        try {
            const r = await fetch(
                `http://localhost:8081/students/updatePassword/${globalState._id}`,
                {
                    method: "PATCH",
        ...
        const fetchImage = async () => {
            try {
                const res = await fetch(
                    `http://localhost:8081/students/getPhoto/${globalState._id}`,
                    {
                        method: "GET",
                                ...
                                <div class="relative">
                                    <input type="file" className="" id="myFileInput" ref={myFileInput}
                                        onChange={async (e) => {
                                            ...
                                            try {
                                                const r = await fetch(
                                                    `http://localhost:8081/students/updateMe/${globalState._id}`,
                                                    {
                                                        method: "PATCH",
                                                        body: data,
                                                        headers: {
