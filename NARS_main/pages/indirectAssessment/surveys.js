    ...
    <div className="flex justify-center  min-h-screen">
      ...
      <div className=" bg-form text-form p-20 max-w-3xl w-full shadow-2xl rounded-3xl mt-10">
       ...
       onSubmit={submitHandler}>
          ...
          <div className="mb-4">
            <label className="block mb-2">Select a Course:</label>
            <select
          ...
          {questions.map((question, index) => (
            <div key={index} className="mb-4">
              ...
              />
              <label className="block mt-2 mb-2">Rating:</label>
              <select
                required
                className="w-full p-2 border rounded"
          ...
          <div className="mb-4">
            <label className="block mb-2">Overall Rating of the Course:</label>
