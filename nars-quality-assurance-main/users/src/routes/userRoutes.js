...
router
  .route("/staff")
  .get(authController.protect, staffController.getAllStaffData)
  .post(authController.protect, staffController.addStaff);
...
router
  .route("/search-staff")
  .post(authController.protect, staffController.searchStaff);
